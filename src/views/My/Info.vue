...
import {listMyCreateTeamsUsingGET, listMyJoinTeamsUsingGET} from "../../api/langbei/teamController";
import {getCurrentUserUsingGET} from "../../api/langbei/userController";
...
onMounted(async () => {
  const resCreate = await listMyCreateTeamsUsingGET({});
  const resJoin = await listMyJoinTeamsUsingGET({});
