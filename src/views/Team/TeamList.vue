  ...
  <div class="common-layout">
    <el-container>
      <el-aside width="130px">
        <el-tabs v-model="status" class="demo-tabs" style="height: 200px" tab-position="left" @tab-change="statusChange">
      ...
      justify-content: space-betwe,">
            <el-input v-model="searchText" :prefix-icon="Search" class="w-50 m-2" placeholder="搜索你感兴趣的队伍吧！"
              @change="doSearch" style="width: 400px;" />
        ...
        <el-main>
          <el-card v-for="(team, index) in teamList" :key="index" shadow="hover" style="margin-bottom: 20px;">
            ...
            <div style="display: flex;  align-items: center;">
              ...
              <el-descriptions :column="4" :title="team.description" border direction="vertical">
